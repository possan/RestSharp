...
namespace RestSharp
{
    ...
    public class RestRequest
    {
        ...
        {
            return AddFile(bytes, fileName, null, null);
        }
        ...
        /// <param name="bytes">The file data</param>
        /// <param name="fileName">The file name to use for the uploaded file</param>
        /// <param name="parameterName">The parameter name to send the file with</param>
        /// <returns>This request</returns>
        public RestRequest AddFile(byte[] bytes, string fileName, string parameterName)
        {
            return AddFile(bytes, fileName, null, parameterName);
        }
        ...
        /// <param name="parameterName">The parameter name to send the file with</param>
        /// <returns>This request</returns>
        public RestRequest AddFile(byte[] bytes, string fileName, string contentType, string parameterName)
        {
            Files.Add(new FileParameter { Data = bytes, FileName = fileName, ContentType = contentType, ParameterName = parameterName });
            return this;
        }
#endif
